...
export class ApiConfig {
    ...
    public static getApiUrl() {
        return "http://cmsdev.helpfooter.com/alucard263096/dudu/api/";
    }
    public static getUploadPath() {
        return "http://cmsdev.helpfooter.com/alucard263096/dudu/upload/";
    }
    public static getFileUploadAPI() {
        return "http://cmsdev.helpfooter.com/alucard263096/dudu/fileupload";
    }
    public static getDataBaseName() {
        return "alucard263096_dudu.db";
    }
