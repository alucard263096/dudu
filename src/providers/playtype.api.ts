...
public list(search_condition_json, showLoadingModal:boolean=true) {
        var url = ApiConfig.getApiUrl()+"playtype/list";
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if(ApiConfig.DataLoadedHandle("playtype/list",search_condition_json,res)){
                  if(showLoadingModal){
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle("playtype/list",search_condition_json,err);
            });
